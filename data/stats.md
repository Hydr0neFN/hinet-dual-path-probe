...
完整資料集：`2026-08-26 11:55:50` → `2026-08-27 23:56:37` · **3259 筆樣本**（每條路徑 `1630` 筆）
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +206 ms | 86.5% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 7.5% |

_由運行中的探針自動重新產生。最後更新：2026-08-27 23:56（UTC+8）_
