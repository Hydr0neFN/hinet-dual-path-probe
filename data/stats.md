...
完整資料集：`2026-08-26 11:55:50` → `2026-08-27 21:55:58` · **3025 筆樣本**（每條路徑 `1513` 筆）
...
|---|---|---|---|---|
| Tokyo SDR relay, UDP RTT (ms) | 34 | 35 | 34 | 41 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +204 ms | 85.5% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 7.6% |

_由運行中的探針自動重新產生。最後更新：2026-08-27 21:56（UTC+8）_
