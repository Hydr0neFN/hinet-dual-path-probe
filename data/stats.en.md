...
Full dataset: `2026-08-26 11:55:50` → `2026-08-31 02:08:49` · **16366 samples** (`8184` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 7 | 94 |
...
| Cloudflare 1.1.1.1 RTT | +1 ms | +91 ms | 48.4% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 7.1% |

_Regenerated automatically by the running probe. Last updated: 2026-08-31 02:09 (UTC+8)._
