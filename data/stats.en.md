...
Full dataset: `2026-08-26 11:55:50` → `2026-09-16 08:11:23` · **86150 samples** (`43076` per path)
...
| Tokyo SDR relay, ICMP RTT (ms) | 34 | 34 | 33 | 40 |
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 3 | 40 |
...
| Tokyo SDR relay, ICMP RTT | +0 ms | +5 ms | 4.7% |
| Cloudflare 1.1.1.1 RTT | +0 ms | +36 ms | 42.5% |
| Google 8.8.8.8 RTT | +0 ms | +6 ms | 5.0% |

_Regenerated automatically by the running probe. Last updated: 2026-09-16 08:12 (UTC+8)._
