...
Full dataset: `2026-08-26 11:55:50` → `2026-09-07 11:09:05` · **47242 samples** (`23622` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 24 | 83 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +80 ms | 72.7% |
| Google 8.8.8.8 RTT | +0 ms | +10 ms | 6.9% |

_Regenerated automatically by the running probe. Last updated: 2026-09-07 11:09 (UTC+8)._
