...
Full dataset: `2026-08-26 11:55:50` → `2026-09-12 13:16:28` · **69620 samples** (`34811` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 10 | 47 |
...
| Cloudflare 1.1.1.1 RTT | +3 ms | +42 ms | 49.8% |
| Google 8.8.8.8 RTT | +0 ms | +6 ms | 5.1% |

_Regenerated automatically by the running probe. Last updated: 2026-09-12 13:17 (UTC+8)._
