...
Full dataset: `2026-08-26 11:55:50` → `2026-09-14 09:09:04` · **77632 samples** (`38817` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 4 | 42 |
...
| Cloudflare 1.1.1.1 RTT | +0 ms | +39 ms | 46.6% |
| Google 8.8.8.8 RTT | +0 ms | +6 ms | 5.0% |

_Regenerated automatically by the running probe. Last updated: 2026-09-14 09:09 (UTC+8)._
