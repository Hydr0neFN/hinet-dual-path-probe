...
Full dataset: `2026-08-26 11:55:50` → `2026-09-11 06:14:49` · **63953 samples** (`31978` per path)
...
| Tokyo SDR relay, ICMP RTT (ms) | 34 | 34 | 34 | 41 |
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 24 | 52 |
| Google 8.8.8.8 RTT (ms) | 2 | 3 | 2 | 10 |

## Paired difference (dynamic minus static, same loop iteration)

| Metric | Median | p95 | Share of samples where dynamic is >5 ms worse |
|---|---|---|---|
| Tokyo SDR relay, UDP RTT | +0 ms | +1 ms | 0.7% |
| Tokyo SDR relay, ICMP RTT | +0 ms | +5 ms | 5.0% |
| Cloudflare 1.1.1.1 RTT | +21 ms | +49 ms | 54.1% |
| Google 8.8.8.8 RTT | +0 ms | +7 ms | 5.4% |

_Regenerated automatically by the running probe. Last updated: 2026-09-11 06:15 (UTC+8)._
