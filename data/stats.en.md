...
Full dataset: `2026-08-26 11:55:50` → `2026-08-31 01:08:37` · **16184 samples** (`8093` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 6 | 98 |
...
| Cloudflare 1.1.1.1 RTT | +1 ms | +95 ms | 47.8% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 7.0% |

_Regenerated automatically by the running probe. Last updated: 2026-08-31 01:09 (UTC+8)._
