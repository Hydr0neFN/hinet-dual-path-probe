...
Full dataset: `2026-08-26 11:55:50` → `2026-09-05 00:12:07` · **36748 samples** (`18375` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 4 | 24 | 98 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +95 ms | 76.8% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 7.8% |

_Regenerated automatically by the running probe. Last updated: 2026-09-05 00:14 (UTC+8)._
