...
Full dataset: `2026-08-26 11:55:50` → `2026-08-31 05:08:44` · **16908 samples** (`8455` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 12 | 88 |
...
| Cloudflare 1.1.1.1 RTT | +6 ms | +85 ms | 50.0% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 7.1% |

_Regenerated automatically by the running probe. Last updated: 2026-08-31 05:09 (UTC+8)._
