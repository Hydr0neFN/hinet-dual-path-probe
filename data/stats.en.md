...
Full dataset: `2026-08-26 11:55:50` → `2026-08-30 11:07:52` · **13858 samples** (`6930` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 3 | 143 |
...
| Cloudflare 1.1.1.1 RTT | +0 ms | +138 ms | 39.0% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 7.2% |

_Regenerated automatically by the running probe. Last updated: 2026-08-30 11:08 (UTC+8)._
