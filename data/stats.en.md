...
Full dataset: `2026-08-26 11:55:50` → `2026-08-30 00:25:38` · **11986 samples** (`5994` per path)
...
|---|---|---|---|
| Tokyo SDR relay, UDP RTT | +0 ms | +4 ms | 2.2% |
| Tokyo SDR relay, ICMP RTT | -1 ms | +7 ms | 5.9% |
| Cloudflare 1.1.1.1 RTT | +0 ms | +165 ms | 43.2% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 6.8% |

_Regenerated automatically by the running probe. Last updated: 2026-08-30 00:26 (UTC+8)._
