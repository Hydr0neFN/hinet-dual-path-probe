...
Full dataset: `2026-08-26 11:55:50` → `2026-08-28 07:56:50` · **4630 samples** (`2316` per path)
...
|---|---|---|---|---|
| Tokyo SDR relay, UDP RTT (ms) | 34 | 37 | 33 | 41 |
| Tokyo SDR relay, ICMP RTT (ms) | 34 | 36 | 34 | 47 |
...
|---|---|---|---|
| Tokyo SDR relay, UDP RTT | +0 ms | +5 ms | 4.6% |
| Tokyo SDR relay, ICMP RTT | +0 ms | +10 ms | 8.4% |
| Cloudflare 1.1.1.1 RTT | +21 ms | +205 ms | 90.5% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 8.3% |

_Regenerated automatically by the running probe. Last updated: 2026-08-28 07:57 (UTC+8)._
