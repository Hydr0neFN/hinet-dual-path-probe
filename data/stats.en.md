...
Full dataset: `2026-08-26 11:55:50` → `2026-08-31 09:09:29` · **17644 samples** (`8823` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 19 | 81 |
...
| Cloudflare 1.1.1.1 RTT | +15 ms | +78 ms | 52.1% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 7.3% |

_Regenerated automatically by the running probe. Last updated: 2026-08-31 09:09 (UTC+8)._
