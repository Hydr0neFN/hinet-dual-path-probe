...
Full dataset: `2026-08-26 11:55:50` → `2026-09-18 19:14:36` · **96950 samples** (`48476` per path)
...
| Cloudflare 1.1.1.1 RTT | +0 ms | +34 ms | 45.1% |
| Google 8.8.8.8 RTT | +0 ms | +5 ms | 4.8% |

_Regenerated automatically by the running probe. Last updated: 2026-09-18 19:15 (UTC+8)._
