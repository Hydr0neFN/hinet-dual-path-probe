...
Full dataset: `2026-08-26 11:55:50` → `2026-09-14 11:09:19` · **77998 samples** (`39000` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 3 | 42 |
...
| Cloudflare 1.1.1.1 RTT | +0 ms | +39 ms | 46.4% |
| Google 8.8.8.8 RTT | +0 ms | +6 ms | 5.0% |

_Regenerated automatically by the running probe. Last updated: 2026-09-14 11:09 (UTC+8)._
