...
Full dataset: `2026-08-26 11:55:50` → `2026-09-14 00:08:56` · **75974 samples** (`37988` per path)
...
| Cloudflare 1.1.1.1 RTT | +1 ms | +39 ms | 47.5% |
| Google 8.8.8.8 RTT | +0 ms | +6 ms | 5.0% |

_Regenerated automatically by the running probe. Last updated: 2026-09-14 00:09 (UTC+8)._
