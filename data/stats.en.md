...
Full dataset: `2026-08-26 11:55:50` → `2026-08-28 08:57:03` · **4816 samples** (`2409` per path)
...
|---|---|---|---|
| Tokyo SDR relay, UDP RTT | +0 ms | +5 ms | 4.4% |
| Tokyo SDR relay, ICMP RTT | +0 ms | +10 ms | 8.5% |
| Cloudflare 1.1.1.1 RTT | +21 ms | +204 ms | 90.9% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 8.3% |

_Regenerated automatically by the running probe. Last updated: 2026-08-28 08:57 (UTC+8)._
