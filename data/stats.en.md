...
Full dataset: `2026-08-26 11:55:50` → `2026-09-18 12:14:06` · **95664 samples** (`47833` per path)
...
| Cloudflare 1.1.1.1 RTT | +0 ms | +34 ms | 44.4% |
| Google 8.8.8.8 RTT | +0 ms | +5 ms | 4.8% |

_Regenerated automatically by the running probe. Last updated: 2026-09-18 12:14 (UTC+8)._
