...
Full dataset: `2026-08-26 11:55:50` → `2026-08-31 10:09:31` · **17830 samples** (`8916` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 21 | 80 |
...
|---|---|---|---|
| Tokyo SDR relay, UDP RTT | +0 ms | +3 ms | 1.8% |
| Tokyo SDR relay, ICMP RTT | +0 ms | +8 ms | 6.3% |
| Cloudflare 1.1.1.1 RTT | +17 ms | +77 ms | 52.6% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 7.2% |

_Regenerated automatically by the running probe. Last updated: 2026-08-31 10:09 (UTC+8)._
