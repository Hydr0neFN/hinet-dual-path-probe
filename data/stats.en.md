...
Full dataset: `2026-08-26 11:55:50` → `2026-09-12 06:16:18` · **68324 samples** (`34163` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 18 | 48 |
...
| Cloudflare 1.1.1.1 RTT | +13 ms | +43 ms | 50.7% |
| Google 8.8.8.8 RTT | +0 ms | +6 ms | 5.1% |

_Regenerated automatically by the running probe. Last updated: 2026-09-12 06:16 (UTC+8)._
