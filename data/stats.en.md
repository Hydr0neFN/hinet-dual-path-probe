...
Full dataset: `2026-08-26 11:55:50` → `2026-09-03 20:14:21` · **32248 samples** (`16125` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 4 | 24 | 59 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +55 ms | 73.6% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 7.9% |

_Regenerated automatically by the running probe. Last updated: 2026-09-03 20:14 (UTC+8)._
