...
Full dataset: `2026-08-26 11:55:50` → `2026-08-28 06:56:51` · **4450 samples** (`2226` per path)
...
|---|---|---|---|---|
| Tokyo SDR relay, UDP RTT (ms) | 34 | 37 | 33 | 42 |
...
|---|---|---|---|
| Tokyo SDR relay, UDP RTT | +0 ms | +5 ms | 4.8% |
| Tokyo SDR relay, ICMP RTT | +0 ms | +10 ms | 8.2% |
| Cloudflare 1.1.1.1 RTT | +21 ms | +205 ms | 90.1% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 8.1% |

_Regenerated automatically by the running probe. Last updated: 2026-08-28 06:57 (UTC+8)._
