...
Full dataset: `2026-08-26 11:55:50` → `2026-09-06 13:08:26` · **43214 samples** (`21608` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 24 | 99 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +96 ms | 79.4% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 7.4% |

_Regenerated automatically by the running probe. Last updated: 2026-09-06 13:08 (UTC+8)._
