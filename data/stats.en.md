...
Full dataset: `2026-08-26 11:55:50` → `2026-09-06 03:39:24` · **41472 samples** (`20737` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 4 | 24 | 114 |
...
| Tokyo SDR relay, ICMP RTT | +0 ms | +8 ms | 7.0% |
| Cloudflare 1.1.1.1 RTT | +21 ms | +110 ms | 79.5% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 7.6% |

_Regenerated automatically by the running probe. Last updated: 2026-09-06 03:40 (UTC+8)._
