...
Full dataset: `2026-08-26 11:55:50` → `2026-09-11 22:15:53` · **66902 samples** (`33452` per path)
...
| Cloudflare 1.1.1.1 RTT | +20 ms | +45 ms | 51.7% |
| Google 8.8.8.8 RTT | +0 ms | +6 ms | 5.2% |

_Regenerated automatically by the running probe. Last updated: 2026-09-11 22:16 (UTC+8)._
