...
Full dataset: `2026-08-26 11:55:50` → `2026-08-29 23:25:36` · **11804 samples** (`5903` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 3 | 171 |
...
| Cloudflare 1.1.1.1 RTT | +0 ms | +167 ms | 43.8% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 6.8% |

_Regenerated automatically by the running probe. Last updated: 2026-08-29 23:26 (UTC+8)._
