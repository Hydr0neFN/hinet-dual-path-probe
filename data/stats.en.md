...
Full dataset: `2026-08-26 11:55:50` → `2026-09-07 14:09:29` · **47802 samples** (`23902` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 24 | 81 |
...
| Tokyo SDR relay, ICMP RTT | +0 ms | +8 ms | 6.3% |
| Cloudflare 1.1.1.1 RTT | +21 ms | +78 ms | 71.9% |
| Google 8.8.8.8 RTT | +0 ms | +10 ms | 6.9% |

_Regenerated automatically by the running probe. Last updated: 2026-09-07 14:10 (UTC+8)._
