...
Full dataset: `2026-08-26 11:55:50` → `2026-08-28 16:03:18` · **6126 samples** (`3064` per path)
...
| Tokyo SDR relay, ICMP RTT (ms) | 34 | 35 | 34 | 46 |
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 24 | 206 |
...
|---|---|---|---|
| Tokyo SDR relay, UDP RTT | +0 ms | +5 ms | 3.5% |
| Tokyo SDR relay, ICMP RTT | +0 ms | +9 ms | 7.8% |
| Cloudflare 1.1.1.1 RTT | +21 ms | +203 ms | 78.4% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 8.2% |

_Regenerated automatically by the running probe. Last updated: 2026-08-28 16:03 (UTC+8)._
