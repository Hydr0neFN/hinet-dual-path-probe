...
Full dataset: `2026-08-26 11:55:50` → `2026-09-04 18:15:27` · **36096 samples** (`18049` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 4 | 24 | 65 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +61 ms | 76.4% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 7.9% |

_Regenerated automatically by the running probe. Last updated: 2026-09-04 18:15 (UTC+8)._
