...
Full dataset: `2026-08-26 11:55:50` → `2026-09-05 19:14:42` · **40184 samples** (`20093` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 4 | 24 | 85 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +82 ms | 78.8% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 7.7% |

_Regenerated automatically by the running probe. Last updated: 2026-09-05 19:15 (UTC+8)._
