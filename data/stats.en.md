...
Full dataset: `2026-08-26 11:55:50` → `2026-09-12 10:16:04` · **69062 samples** (`34532` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 13 | 47 |
...
| Cloudflare 1.1.1.1 RTT | +7 ms | +43 ms | 50.1% |
| Google 8.8.8.8 RTT | +0 ms | +6 ms | 5.1% |

_Regenerated automatically by the running probe. Last updated: 2026-09-12 10:16 (UTC+8)._
