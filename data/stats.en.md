...
Full dataset: `2026-08-26 11:55:50` → `2026-09-09 15:12:23` · **56838 samples** (`28420` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 24 | 65 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +61 ms | 60.7% |
| Google 8.8.8.8 RTT | +0 ms | +8 ms | 6.0% |

_Regenerated automatically by the running probe. Last updated: 2026-09-09 15:12 (UTC+8)._
