...
Full dataset: `2026-08-26 11:55:50` → `2026-09-12 03:15:33` · **67776 samples** (`33889` per path)
...
| Cloudflare 1.1.1.1 RTT | +18 ms | +44 ms | 51.1% |
| Google 8.8.8.8 RTT | +0 ms | +6 ms | 5.1% |

_Regenerated automatically by the running probe. Last updated: 2026-09-12 03:16 (UTC+8)._
