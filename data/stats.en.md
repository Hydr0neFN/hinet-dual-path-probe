...
Full dataset: `2026-08-26 11:55:50` → `2026-08-29 15:03:31` · **10280 samples** (`5141` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 10 | 182 |
...
| Tokyo SDR relay, ICMP RTT | -1 ms | +7 ms | 6.5% |
| Cloudflare 1.1.1.1 RTT | +5 ms | +178 ms | 49.9% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 7.5% |

_Regenerated automatically by the running probe. Last updated: 2026-08-29 15:04 (UTC+8)._
