...
Full dataset: `2026-08-26 11:55:50` → `2026-08-31 08:09:31` · **17464 samples** (`8733` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 16 | 83 |
...
| Cloudflare 1.1.1.1 RTT | +12 ms | +80 ms | 51.6% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 7.2% |

_Regenerated automatically by the running probe. Last updated: 2026-08-31 08:09 (UTC+8)._
