...
Full dataset: `2026-08-26 11:55:50` → `2026-09-09 17:12:28` · **57210 samples** (`28606` per path)
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +61 ms | 60.3% |
| Google 8.8.8.8 RTT | +0 ms | +8 ms | 6.0% |

_Regenerated automatically by the running probe. Last updated: 2026-09-09 17:13 (UTC+8)._
