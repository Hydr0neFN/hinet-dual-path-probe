...
Full dataset: `2026-08-26 11:55:50` → `2026-08-29 01:02:26` · **7744 samples** (`3873` per path)
...
|---|---|---|---|---|
| Tokyo SDR relay, UDP RTT (ms) | 34 | 37 | 33 | 40 |
| Tokyo SDR relay, ICMP RTT (ms) | 34 | 36 | 34 | 45 |
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 24 | 199 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +196 ms | 62.3% |
| Google 8.8.8.8 RTT | +0 ms | +10 ms | 6.8% |

_Regenerated automatically by the running probe. Last updated: 2026-08-29 01:03 (UTC+8)._
