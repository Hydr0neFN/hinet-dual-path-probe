...
Full dataset: `2026-08-26 11:55:50` → `2026-09-04 23:13:23` · **36636 samples** (`18319` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 4 | 24 | 87 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +84 ms | 76.8% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 7.8% |

_Regenerated automatically by the running probe. Last updated: 2026-09-04 23:14 (UTC+8)._
