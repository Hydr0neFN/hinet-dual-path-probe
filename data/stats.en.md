...
Full dataset: `2026-08-26 11:55:50` → `2026-09-04 19:13:09` · **36204 samples** (`18103` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 4 | 24 | 69 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +65 ms | 76.5% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 7.8% |

_Regenerated automatically by the running probe. Last updated: 2026-09-04 19:15 (UTC+8)._
