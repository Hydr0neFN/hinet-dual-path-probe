...
Full dataset: `2026-08-26 11:55:50` → `2026-08-28 15:02:50` · **5940 samples** (`2971` per path)
...
|---|---|---|---|
| Tokyo SDR relay, UDP RTT | +0 ms | +5 ms | 3.6% |
| Tokyo SDR relay, ICMP RTT | +0 ms | +9 ms | 8.1% |
| Cloudflare 1.1.1.1 RTT | +21 ms | +203 ms | 80.8% |
| Google 8.8.8.8 RTT | +0 ms | +13 ms | 8.4% |

_Regenerated automatically by the running probe. Last updated: 2026-08-28 15:03 (UTC+8)._
