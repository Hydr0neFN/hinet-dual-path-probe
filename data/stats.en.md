...
Full dataset: `2026-08-26 11:55:50` → `2026-09-18 08:13:59` · **94930 samples** (`47466` per path)
...
| Cloudflare 1.1.1.1 RTT | +0 ms | +34 ms | 43.9% |
| Google 8.8.8.8 RTT | +0 ms | +5 ms | 4.8% |

_Regenerated automatically by the running probe. Last updated: 2026-09-18 08:14 (UTC+8)._
