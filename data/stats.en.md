...
Full dataset: `2026-08-26 11:55:50` → `2026-09-05 13:14:45` · **39106 samples** (`19554` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 4 | 24 | 89 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +86 ms | 78.2% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 7.7% |

_Regenerated automatically by the running probe. Last updated: 2026-09-05 13:15 (UTC+8)._
