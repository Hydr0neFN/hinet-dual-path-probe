...
Full dataset: `2026-08-26 11:55:50` → `2026-09-11 12:15:06` · **65062 samples** (`32532` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 24 | 50 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +47 ms | 53.1% |
| Google 8.8.8.8 RTT | +0 ms | +6 ms | 5.3% |

_Regenerated automatically by the running probe. Last updated: 2026-09-11 12:15 (UTC+8)._
