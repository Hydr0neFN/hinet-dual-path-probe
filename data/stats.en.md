...
Full dataset: `2026-08-26 11:55:50` → `2026-09-12 14:16:42` · **69806 samples** (`34904` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 9 | 47 |
...
| Cloudflare 1.1.1.1 RTT | +2 ms | +42 ms | 49.6% |
| Google 8.8.8.8 RTT | +0 ms | +6 ms | 5.1% |

_Regenerated automatically by the running probe. Last updated: 2026-09-12 14:17 (UTC+8)._
