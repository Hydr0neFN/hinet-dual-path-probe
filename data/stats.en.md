...
Full dataset: `2026-08-26 11:55:50` → `2026-09-09 18:12:20` · **57394 samples** (`28698` per path)
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +60 ms | 60.2% |
| Google 8.8.8.8 RTT | +0 ms | +8 ms | 5.9% |

_Regenerated automatically by the running probe. Last updated: 2026-09-09 18:13 (UTC+8)._
