...
Full dataset: `2026-08-26 11:55:50` → `2026-09-12 09:16:14` · **68876 samples** (`34439` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 14 | 47 |
...
| Cloudflare 1.1.1.1 RTT | +9 ms | +43 ms | 50.3% |
| Google 8.8.8.8 RTT | +0 ms | +6 ms | 5.1% |

_Regenerated automatically by the running probe. Last updated: 2026-09-12 09:16 (UTC+8)._
