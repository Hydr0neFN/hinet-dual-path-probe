...
Full dataset: `2026-08-26 11:55:50` → `2026-09-10 12:13:16` · **60654 samples** (`30328` per path)
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +53 ms | 57.0% |
| Google 8.8.8.8 RTT | +0 ms | +8 ms | 5.7% |

_Regenerated automatically by the running probe. Last updated: 2026-09-10 12:14 (UTC+8)._
