...
Full dataset: `2026-08-26 11:55:50` → `2026-09-10 06:13:14` · **59540 samples** (`29771` per path)
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +55 ms | 58.0% |
| Google 8.8.8.8 RTT | +0 ms | +8 ms | 5.7% |

_Regenerated automatically by the running probe. Last updated: 2026-09-10 06:13 (UTC+8)._
