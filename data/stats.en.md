...
Full dataset: `2026-08-26 11:55:50` → `2026-09-04 21:13:45` · **36436 samples** (`18219` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 4 | 24 | 75 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +72 ms | 76.6% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 7.8% |

_Regenerated automatically by the running probe. Last updated: 2026-09-04 21:16 (UTC+8)._
