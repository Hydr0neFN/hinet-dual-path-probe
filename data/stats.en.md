...
Full dataset: `2026-08-26 11:55:50` → `2026-09-12 02:16:03` · **67596 samples** (`33799` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 23 | 48 |
...
| Cloudflare 1.1.1.1 RTT | +20 ms | +44 ms | 51.2% |
| Google 8.8.8.8 RTT | +0 ms | +6 ms | 5.2% |

_Regenerated automatically by the running probe. Last updated: 2026-09-12 02:16 (UTC+8)._
