...
Full dataset: `2026-08-26 11:55:50` → `2026-09-01 20:11:09` · **23852 samples** (`11927` per path)
...
|---|---|---|---|
| Tokyo SDR relay, UDP RTT | +0 ms | +2 ms | 1.3% |
| Tokyo SDR relay, ICMP RTT | +0 ms | +8 ms | 6.7% |
| Cloudflare 1.1.1.1 RTT | +21 ms | +57 ms | 64.6% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 7.3% |

_Regenerated automatically by the running probe. Last updated: 2026-09-01 20:11 (UTC+8)._
