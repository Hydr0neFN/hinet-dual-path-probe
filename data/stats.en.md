...
Full dataset: `2026-08-26 11:55:50` → `2026-08-30 13:08:26` · **14220 samples** (`7111` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 3 | 136 |
...
| Cloudflare 1.1.1.1 RTT | +0 ms | +131 ms | 40.5% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 7.3% |

_Regenerated automatically by the running probe. Last updated: 2026-08-30 13:08 (UTC+8)._
