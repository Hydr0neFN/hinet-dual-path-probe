...
Full dataset: `2026-08-26 11:55:50` → `2026-09-07 09:09:22` · **46870 samples** (`23436` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 24 | 84 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +81 ms | 73.3% |
| Google 8.8.8.8 RTT | +0 ms | +10 ms | 6.9% |

_Regenerated automatically by the running probe. Last updated: 2026-09-07 09:09 (UTC+8)._
