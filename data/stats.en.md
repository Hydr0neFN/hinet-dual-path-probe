...
Full dataset: `2026-08-26 11:55:50` → `2026-09-10 16:13:30` · **61386 samples** (`30694` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 24 | 56 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +52 ms | 56.3% |
| Google 8.8.8.8 RTT | +0 ms | +7 ms | 5.6% |

_Regenerated automatically by the running probe. Last updated: 2026-09-10 16:14 (UTC+8)._
