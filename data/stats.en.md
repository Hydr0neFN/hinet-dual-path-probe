...
Full dataset: `2026-08-26 11:55:50` → `2026-09-04 22:15:35` · **36540 samples** (`18271` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 4 | 24 | 81 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +78 ms | 76.7% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 7.8% |

_Regenerated automatically by the running probe. Last updated: 2026-09-04 22:16 (UTC+8)._
