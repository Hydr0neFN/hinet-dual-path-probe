...
Full dataset: `2026-08-26 11:55:50` → `2026-08-31 00:08:25` · **16002 samples** (`8002` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 4 | 100 |
...
| Cloudflare 1.1.1.1 RTT | +1 ms | +97 ms | 47.2% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 7.0% |

_Regenerated automatically by the running probe. Last updated: 2026-08-31 00:09 (UTC+8)._
