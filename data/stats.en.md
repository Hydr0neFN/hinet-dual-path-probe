...
Full dataset: `2026-08-26 11:55:50` → `2026-09-05 21:15:00` · **40514 samples** (`20258` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 4 | 24 | 86 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +83 ms | 79.0% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 7.6% |

_Regenerated automatically by the running probe. Last updated: 2026-09-05 21:15 (UTC+8)._
