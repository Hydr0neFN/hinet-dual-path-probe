...
Full dataset: `2026-08-26 11:55:50` → `2026-09-14 05:09:04` · **76888 samples** (`38445` per path)
...
| Cloudflare 1.1.1.1 RTT | +1 ms | +39 ms | 47.0% |
| Google 8.8.8.8 RTT | +0 ms | +6 ms | 5.0% |

_Regenerated automatically by the running probe. Last updated: 2026-09-14 05:09 (UTC+8)._
