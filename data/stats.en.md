...
Full dataset: `2026-08-26 11:55:50` → `2026-08-31 11:09:45` · **18004 samples** (`9003` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 23 | 79 |
...
| Cloudflare 1.1.1.1 RTT | +20 ms | +76 ms | 53.1% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 7.2% |

_Regenerated automatically by the running probe. Last updated: 2026-08-31 11:10 (UTC+8)._
