...
Full dataset: `2026-08-26 11:55:50` → `2026-09-03 17:13:43` · **31700 samples** (`15851` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 4 | 24 | 60 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +56 ms | 73.1% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 7.8% |

_Regenerated automatically by the running probe. Last updated: 2026-09-03 17:14 (UTC+8)._
