...
Full dataset: `2026-08-26 11:55:50` → `2026-09-14 23:09:59` · **80096 samples** (`40049` per path)
...
| Cloudflare 1.1.1.1 RTT | +0 ms | +38 ms | 45.4% |
| Google 8.8.8.8 RTT | +0 ms | +6 ms | 5.1% |

_Regenerated automatically by the running probe. Last updated: 2026-09-14 23:10 (UTC+8)._
