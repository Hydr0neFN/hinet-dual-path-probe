...
Full dataset: `2026-08-26 11:55:50` → `2026-08-28 11:02:37` · **5202 samples** (`2602` per path)
...
|---|---|---|---|
| Tokyo SDR relay, UDP RTT | +0 ms | +5 ms | 4.1% |
| Tokyo SDR relay, ICMP RTT | +0 ms | +10 ms | 8.5% |
| Cloudflare 1.1.1.1 RTT | +21 ms | +204 ms | 91.2% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 8.4% |

_Regenerated automatically by the running probe. Last updated: 2026-08-28 11:03 (UTC+8)._
