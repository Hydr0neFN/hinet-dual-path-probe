...
Full dataset: `2026-08-26 11:55:50` → `2026-09-10 22:13:58` · **62486 samples** (`31244` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 24 | 54 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +50 ms | 55.3% |
| Google 8.8.8.8 RTT | +0 ms | +7 ms | 5.5% |

_Regenerated automatically by the running probe. Last updated: 2026-09-10 22:14 (UTC+8)._
