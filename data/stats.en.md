...
Full dataset: `2026-08-26 11:55:50` → `2026-09-08 18:11:05` · **52972 samples** (`26487` per path)
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +68 ms | 65.1% |
| Google 8.8.8.8 RTT | +0 ms | +9 ms | 6.4% |

_Regenerated automatically by the running probe. Last updated: 2026-09-08 18:11 (UTC+8)._
