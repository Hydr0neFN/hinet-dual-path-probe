...
Full dataset: `2026-08-26 11:55:50` → `2026-09-10 04:13:02` · **59170 samples** (`29586` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 24 | 60 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +56 ms | 58.4% |
| Google 8.8.8.8 RTT | +0 ms | +8 ms | 5.8% |

_Regenerated automatically by the running probe. Last updated: 2026-09-10 04:13 (UTC+8)._
