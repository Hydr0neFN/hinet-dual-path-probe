...
Full dataset: `2026-08-26 11:55:50` → `2026-08-28 03:56:21` · **3904 samples** (`1953` per path)
...
|---|---|---|---|---|
| Tokyo SDR relay, UDP RTT (ms) | 34 | 39 | 33 | 43 |
| Tokyo SDR relay, ICMP RTT (ms) | 34 | 38 | 34 | 48 |
...
|---|---|---|---|
| Tokyo SDR relay, UDP RTT | +0 ms | +6 ms | 5.3% |
| Tokyo SDR relay, ICMP RTT | +0 ms | +10 ms | 8.2% |
| Cloudflare 1.1.1.1 RTT | +21 ms | +205 ms | 88.7% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 7.7% |

_Regenerated automatically by the running probe. Last updated: 2026-08-28 03:57 (UTC+8)._
