...
Full dataset: `2026-08-26 11:55:50` → `2026-09-18 20:14:37` · **97134 samples** (`48568` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 3 | 37 |
...
| Cloudflare 1.1.1.1 RTT | +0 ms | +34 ms | 45.2% |
| Google 8.8.8.8 RTT | +0 ms | +5 ms | 4.8% |

_Regenerated automatically by the running probe. Last updated: 2026-09-18 20:15 (UTC+8)._
