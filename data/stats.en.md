...
Full dataset: `2026-08-26 11:55:50` → `2026-09-20 23:08:59` · **106290 samples** (`53146` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 4 | 37 |
...
| Cloudflare 1.1.1.1 RTT | +1 ms | +34 ms | 47.9% |
| Google 8.8.8.8 RTT | +0 ms | +5 ms | 4.8% |

_Regenerated automatically by the running probe. Last updated: 2026-09-20 23:09 (UTC+8)._
