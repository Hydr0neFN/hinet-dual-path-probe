...
Full dataset: `2026-08-26 11:55:50` → `2026-09-09 02:11:31` · **54424 samples** (`27213` per path)
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +66 ms | 63.4% |
| Google 8.8.8.8 RTT | +0 ms | +9 ms | 6.2% |

_Regenerated automatically by the running probe. Last updated: 2026-09-09 02:12 (UTC+8)._
