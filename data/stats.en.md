...
Full dataset: `2026-08-26 11:55:50` → `2026-09-03 11:13:31` · **30596 samples** (`15299` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 4 | 24 | 63 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +59 ms | 72.2% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 7.6% |

_Regenerated automatically by the running probe. Last updated: 2026-09-03 11:14 (UTC+8)._
