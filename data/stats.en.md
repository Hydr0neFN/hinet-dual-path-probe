...
Full dataset: `2026-08-26 11:55:50` → `2026-09-13 15:08:38` · **74364 samples** (`37183` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 4 | 44 |
...
| Cloudflare 1.1.1.1 RTT | +1 ms | +40 ms | 48.4% |
| Google 8.8.8.8 RTT | +0 ms | +6 ms | 5.0% |

_Regenerated automatically by the running probe. Last updated: 2026-09-13 15:09 (UTC+8)._
