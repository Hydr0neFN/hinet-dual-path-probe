...
Full dataset: `2026-08-26 11:55:50` → `2026-08-29 06:02:38` · **8642 samples** (`4322` per path)
...
| Tokyo SDR relay, ICMP RTT (ms) | 34 | 36 | 33 | 44 |
...
|---|---|---|---|
| Tokyo SDR relay, UDP RTT | +0 ms | +4 ms | 2.7% |
| Tokyo SDR relay, ICMP RTT | +0 ms | +7 ms | 6.2% |
| Cloudflare 1.1.1.1 RTT | +21 ms | +190 ms | 56.8% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 6.9% |

_Regenerated automatically by the running probe. Last updated: 2026-08-29 06:03 (UTC+8)._
