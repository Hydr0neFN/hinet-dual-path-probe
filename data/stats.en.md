...
Full dataset: `2026-08-26 11:55:50` → `2026-08-31 12:09:26` · **18188 samples** (`9095` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 24 | 78 |
...
| Cloudflare 1.1.1.1 RTT | +20 ms | +75 ms | 53.5% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 7.3% |

_Regenerated automatically by the running probe. Last updated: 2026-08-31 12:10 (UTC+8)._
