...
Full dataset: `2026-08-26 11:55:50` → `2026-09-05 08:13:59` · **38178 samples** (`19090` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 4 | 24 | 94 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +91 ms | 77.7% |
| Google 8.8.8.8 RTT | +0 ms | +12 ms | 7.7% |

_Regenerated automatically by the running probe. Last updated: 2026-09-05 08:14 (UTC+8)._
