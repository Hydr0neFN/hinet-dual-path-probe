...
Full dataset: `2026-08-26 11:55:50` → `2026-09-06 16:08:11` · **43768 samples** (`21885` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 24 | 96 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +93 ms | 78.4% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 7.3% |

_Regenerated automatically by the running probe. Last updated: 2026-09-06 16:08 (UTC+8)._
