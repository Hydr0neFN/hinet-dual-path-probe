...
Full dataset: `2026-08-26 11:55:50` → `2026-09-12 04:15:52` · **67958 samples** (`33980` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 22 | 48 |
...
| Cloudflare 1.1.1.1 RTT | +17 ms | +44 ms | 50.9% |
| Google 8.8.8.8 RTT | +0 ms | +6 ms | 5.1% |

_Regenerated automatically by the running probe. Last updated: 2026-09-12 04:16 (UTC+8)._
