...
Full dataset: `2026-08-26 11:55:50` → `2026-08-31 23:10:26` · **20054 samples** (`10028` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 24 | 75 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +72 ms | 57.9% |
| Google 8.8.8.8 RTT | +0 ms | +11 ms | 7.3% |

_Regenerated automatically by the running probe. Last updated: 2026-08-31 23:10 (UTC+8)._
