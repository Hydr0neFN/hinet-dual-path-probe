...
Full dataset: `2026-08-26 11:55:50` → `2026-09-09 07:11:48` · **55346 samples** (`27674` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 24 | 68 |
...
| Tokyo SDR relay, ICMP RTT | +0 ms | +7 ms | 5.7% |
| Cloudflare 1.1.1.1 RTT | +21 ms | +64 ms | 62.3% |
| Google 8.8.8.8 RTT | +0 ms | +9 ms | 6.1% |

_Regenerated automatically by the running probe. Last updated: 2026-09-09 07:12 (UTC+8)._
