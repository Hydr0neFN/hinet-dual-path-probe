...
Full dataset: `2026-08-26 11:55:50` → `2026-09-11 09:14:35` · **64506 samples** (`32254` per path)
...
| Cloudflare 1.1.1.1 RTT (ms) | 3 | 3 | 24 | 51 |
...
| Cloudflare 1.1.1.1 RTT | +21 ms | +48 ms | 53.6% |
| Google 8.8.8.8 RTT | +0 ms | +6 ms | 5.4% |

_Regenerated automatically by the running probe. Last updated: 2026-09-11 09:15 (UTC+8)._
