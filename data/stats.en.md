...
Full dataset: `2026-08-26 11:55:50` → `2026-09-14 15:09:30` · **78742 samples** (`39372` per path)
...
| Cloudflare 1.1.1.1 RTT | +0 ms | +38 ms | 46.1% |
| Google 8.8.8.8 RTT | +0 ms | +6 ms | 5.1% |

_Regenerated automatically by the running probe. Last updated: 2026-09-14 15:09 (UTC+8)._
